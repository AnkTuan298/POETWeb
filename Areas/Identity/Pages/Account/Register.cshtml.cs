...
namespace POETWeb.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        public class InputModel
        {
            ...
            [StringLength(20, ErrorMessage = "{0} must be between {2} and {1} characters.", MinimumLength = 4)]
            [RegularExpression(@"^[a-zA-Z0-9._-]+$", ErrorMessage = "User name can only contain letters, numbers, dots, underscores, and hyphens.")]
